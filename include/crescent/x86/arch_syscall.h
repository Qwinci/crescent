...
static inline long __syscall0(long num) {
	...
	// num
	// rdi
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall1(long num, long a0) {
	...
	// num a0
	// rdi rsi
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall2(long num, long a0, long a1) {
	...
	// num a0  a1
	// rdi rsi rdx
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall3(long num, long a0, long a1, long a2) {
	...
	// num a0  a1  a2
	// rdi rsi rdx rax
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall4(long num, long a0, long a1, long a2, long a3) {
	...
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall5(long num, long a0, long a1, long a2, long a3, long a4) {
	...
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8), "r"(r9) : "rcx", "r11");
	return ret;
}
...
static inline long __syscall6(long num, long a0, long a1, long a2, long a3, long a4, long a5) {
	...
	__asm__ volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8), "r"(r9), "r"(r10) : "rcx", "r11");
	return ret;
}
