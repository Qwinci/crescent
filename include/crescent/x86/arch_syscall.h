...
static inline long __syscall0(long num) {
	...
	// num
	// rdi
	asm volatile("syscall" : "=a"(ret) : "D"(num));
	return ret;
}
...
static inline long __syscall1(long num, long a0) {
	...
	// num a0
	// rdi rsi
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0));
	return ret;
}
...
static inline long __syscall2(long num, long a0, long a1) {
	...
	// num a0  a1
	// rdi rsi rdx
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1));
	return ret;
}
...
static inline long __syscall3(long num, long a0, long a1, long a2) {
	...
	// num a0  a1  a2
	// rdi rsi rdx rax
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2));
	return ret;
}
...
static inline long __syscall4(long num, long a0, long a1, long a2, long a3) {
	...
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8));
	return ret;
}
...
static inline long __syscall5(long num, long a0, long a1, long a2, long a3, long a4) {
	...
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8), "r"(r9));
	return ret;
}
...
static inline long __syscall6(long num, long a0, long a1, long a2, long a3, long a4, long a5) {
	...
	asm volatile("syscall" : "=a"(ret) : "D"(num), "S"(a0), "d"(a1), "a"(a2), "r"(r8), "r"(r9), "r"(r10));
	return ret;
}
